...
namespace NewShop.Controllers
{
    public class BackOrderAllController : Controller
    {
        ...
        public ActionResult Filter(string CUSCOD, string SLMID, string Show_Flag, string Stock_Flag, string stkcod, string DocumentNo,string COM)
        {
        ...
        public JsonResult getbackorder(string CUSCOD, string SLMID, string Show_Flag, string Stock_Flag, string stkcod, string DocumentNo, string COM)
        {
